  ...
  configSchema: {
    schema: {
      ...
      properties: {
        ...
        wsEndpoint: { type: "string", format: "uri", title: "WebSocket 地址", description: "微博 WebSocket 服务地址" },
        tokenEndpoint: { type: "string", format: "uri", title: "Token 服务地址", description: "获取 WebSocket Token 的服务地址" },
        ...
        accounts: {
          ...
          additionalProperties: {
            ...
            properties: {
              ...
              appId: { type: "string", title: "App ID", description: "App ID" },
              appSecret: { type: "string", title: "App Secret", description: "App Secret" },
              wsEndpoint: { type: "string", title: "WebSocket 地址", description: "微博 WebSocket 服务地址" },
              tokenEndpoint: { type: "string", title: "Token 服务地址", description: "获取 WebSocket Token 的服务地址" },
              textChunkLimit: { type: "integer", minimum: 1, title: "文本分片限制", description: "单条消息最大字符数，超出后自动分片" },
              chunkMode: { type: "string", enum: ["length", "newline"], default: "newline", title: "分片模式", description: "newline=按换行分片, length=按字符数分片" },
            },
          },
